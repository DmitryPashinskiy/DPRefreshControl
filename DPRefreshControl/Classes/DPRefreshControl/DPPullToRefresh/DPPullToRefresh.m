...
@interface DPPullToRefresh (WorkWithKVO)
...
@implementation DPPullToRefresh
...
- (void)stopRefresh {
    ...
    [UIView animateWithDuration:kDPInsetsAnimationDuration
                     animations:^{
                         [self.refreshAnimation animationViewWillHideWithDuration:kDPInsetsAnimationDuration];
                         [self resetInsets];
...
@implementation DPPullToRefresh (WorkWithKVO)
