...
@interface DPRefreshDefaultAnimation ()
...
@implementation DPRefreshDefaultAnimation
...
+ (instancetype)animation {
    return [[DPRefreshDefaultAnimation alloc] initPrivate];
}
